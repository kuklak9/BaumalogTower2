...
using BTPLogs;
using BTPLogin;
using BTPTranslation;

namespace BTPControlLibrary
{
    public class MainPanel : UserControl
    {
        //protected BTPTwinCatADS.PLC _plc = null;
        //protected DB_WMS_3 _dbWMS = null;
        //protected BTPConfig.Configuration _cfg = null;
        //protected BTPCLInput.Keyboard _keyboard;
        //protected BTPCLInput.NumericKeyboard _numericKeyboard;
        //protected BTPLogs.Logs _log = null;
        //protected BTPLogs.EventErrorLogger _eventErrorLogger = null;
        //protected BTPLogin.LoggedUser _loggedUser = null;
        ...
        public static void InitFirst(Keyboard kb, NumericKeyboard nkb, DB_WMS_3 db, Configuration cfg, Logs log, LoggedUser lu, PLC plc, Translation translation, EventErrorLogger errorLogger)
        {
            _dbWMS = db;
            _cfg = cfg;
            _keyboard = kb;
        ...
        public int ActualTrayInWindow = 0;
        ...
        protected void tb_with_kb_Leave(object sender, EventArgs e)
        {

            //if (_keyboard.Focused)
            //{
            //    return;
            //}
        ...
        protected void tb_with_nkb_Leave(object sender, EventArgs e)
        {
            //Control c = this.ActiveControl;
            //if (_numericKeyboard.Focused)
            //{
            //    return;
            //}
        ...
        [Description("On button click"), Category("UC"), Browsable(true), EditorBrowsable(EditorBrowsableState.Always)]
        ...
        public void AddButtonClickLog(Button bt, Colors c_btOn, string s_btOn, string s_btOff, string device)
        {
            bt.Click += delegate (object sender, RoutedEventArgs e)
            {
